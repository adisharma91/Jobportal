...
class Form19c_Old(models.Model):
    ...
    doj = models.DateField(null=True, blank=True)
    leaving_date = models.DateField(null=True, blank=True)
    leaving_reason = models.CharField(max_length=200, null=True, blank=True)
    PAN = models.CharField(max_length=50, null=True, blank=True)
    address = models.CharField(max_length=200, null=True, blank=True)
    ...
    saving_bank_address = models.CharField(max_length=200, null=True, blank=True)
    saving_bank_IFSC = models.CharField(max_length=20, null=True, blank=True)
